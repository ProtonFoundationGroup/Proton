...
// proton is the official command-line client for Ethereum.
package main
...
const (
	clientIdentifier = "proton" // Client identifier to advertise over the network
)
...
var (
	...
	app = utils.NewApp(gitCommit, "the Proton command line interface")
...
func init() {
	...
	app.Copyright = "Copyright 2018 The Proton Author (Ethereum-based)"
...
// proton is the main entry point into the system if no special subcommand is ran.
// It creates a default node based on the command line arguments and runs it in
// blocking mode, waiting for it to be shut down.
func proton(ctx *cli.Context) error {
