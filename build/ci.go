...
import (
	...
	"github.com/ProtonFundation/Proton/internal/build"
	"strconv"
)
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/ProtonFundation/Proton/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "--target", "ios", "--tags", "ios", "-v", "github.com/ProtonFundation/Proton/mobile")
