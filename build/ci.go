...
import (
	...
	"github.com/ProtonFoundation/Proton/internal/build"
	"strconv"
)
...
func doInstall(cmdline []string) {
	...
	if v0 <= 1 && v1 < 9 && !strings.Contains(runtime.Version(), "devel") {
		...
		log.Println("Proton requires at least Go version 1.9 and cannot")
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/ProtonFoundation/Proton/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "--target", "ios", "--tags", "ios", "-v", "github.com/ProtonFoundation/Proton/mobile")
